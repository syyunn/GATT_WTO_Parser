...
```
    ...
    <ipython-input-157-591946172b48> in <module>()
    ----> 1 trial.entire() #only works for FACTUAL and MAIN as of NOW
    

    <ipython-input-149-53e345da1c1f> in entire(self)
         90         self.toc_parser_all() #list the options of toc chapter
         91 
    ---> 92         want = input("What do you want? Choose one among contents: Then type-in")
         93         print("You have sub-field of {} : {}".format(want, self.cited_parser(want)))
         94 
...
```
    ...
    <ipython-input-158-73daf1dcdcb7> in <module>()
    ----> 1 trial.entire()
    ...
    <ipython-input-149-53e345da1c1f> in entire(self)
        100                 pass
        101 
    --> 102         want = input("What do you want? Choose one among contents: Then type-in")
        103 
        104         start = self.con_op_locer(want)
